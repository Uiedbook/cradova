// Simple todo list
import { a, button, Comp, div, h1, input, main, p, Page, Router, Signal, useEffect, useRef, useState, } from "../dist/index.js";
// creating a store
...
function typingExample() {
    ...
    }), p(" no thing typed yet!", { reference: ref.bindAs("text") }), a({ href: "/p" }, "log lol in the console"));
}
function App() {
...
Router.BrowserRoutes({
    ...
    "/": new Page({
        ...
        template() {
            return div(button("go to comp as page", {
                onclick() {
                    Router.navigate("/p");
                },
            }), TodoList, App);
