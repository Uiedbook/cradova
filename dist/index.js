...
$parcel$export(module.exports, "swipe", () => $aafaf9ebb4b860c0$export$32e668afce77959f);
$parcel$export(module.exports, "createSignal", () => $833debe4edef2435$export$8210dfe1863c478);
$parcel$export(module.exports, "Router", () => $14558a07fc6e8338$export$55185c17a0fcbe46);
$parcel$export(module.exports, "Screen", () => $f6990bd003c706fc$export$a98515d67472a41f);
$parcel$export(module.exports, "Scaffold", () => $6d1c6e7469cb566a$export$e460bf4b68e36254);
$parcel$export(module.exports, "dispatch", () => $c2ad58edccfaf3f7$export$635e15bbd66f01ea);
$parcel$export(module.exports, "Ajax", () => $2ba70f089ec95838$export$7a330199b2e76989);
$parcel$export(module.exports, "frag", () => $8c50abc064e8cb26$export$6a2d9549213d3666);
$parcel$export(module.exports, "fullScreen", () => $8c50abc064e8cb26$export$708e76f13b8a286c);
$parcel$export(module.exports, "assert", () => $8c50abc064e8cb26$export$a7a9523472993e97);
$parcel$export(module.exports, "uuid", () => $8c50abc064e8cb26$export$31b40729666a4ae0);
$parcel$export(module.exports, "animate", () => $8c50abc064e8cb26$export$e3607ec2d7a891c4);
$parcel$export(module.exports, "controls", () => $8c50abc064e8cb26$export$cc1adf6fb659c762);
$parcel$export(module.exports, "PromptBeforeLeave", () => $8c50abc064e8cb26$export$5313b17bb82557eb);
$parcel$export(module.exports, "RefElement", () => $8c50abc064e8cb26$export$6011af8918805fc);
$parcel$export(module.exports, "css", () => $8c50abc064e8cb26$export$dbf350e5966cf602);
$parcel$export(module.exports, "media", () => $8c50abc064e8cb26$export$987d49ffe1b0900f);
$parcel$export(module.exports, "ls", () => $8c50abc064e8cb26$export$e0412d591d45e9b);
$parcel$export(module.exports, "Ref", () => $8c50abc064e8cb26$export$9bcc32033bdd12aa);
$parcel$export(module.exports, "RefList", () => $8c50abc064e8cb26$export$1b6f95c075a87882);
$parcel$export(module.exports, "assertOr", () => $8c50abc064e8cb26$export$7a68a2580db7d6aa);
/*
 ...
 * @param callabck
 * @param touching?
 */ function $aafaf9ebb4b860c0$export$32e668afce77959f(callabck, touching = false) {
    if (!(typeof callabck === "function")) throw new Error(" ✘  Cradova err:  no function given for the swipe handler");
    ...
    function handleGesure(event) {
        touchendX = Math.round(event.changedTouches[event.changedTouches.length - 1].clientX);
        touchendY = Math.round(event.changedTouches[event.changedTouches.length - 1].clientY);
        //
        if (touching) capturedGesture.top = capturedGesture.down = capturedGesture.right = capturedGesture.left = capturedGesture.tap = capturedGesture.touch = 0;
        if (touching) {
            if (touchingState) {
        ...
        if (touchendX > touchstartX) capturedGesture.right = touchendX - touchstartX;
    ...
    return {
        ...
        stop () {
            if (touching) escapeTSError.removeEventListener("touchmove", handleGesure);
            else {
 ...
 */ class $833debe4edef2435$export$8210dfe1863c478 {
   ...
   */ set(value, shouldRefRender) {
        ...
        if (this.persistName) localStorage.setItem(this.persistName, JSON.stringify(this.value));
   ...
   */ setIndex(key, index, value, shouldRefRender) {
        ...
        else throw new Error("✘  Cradova err :  " + this.value[key] + "  is not an array ");
        if (this.ref && shouldRefRender !== false) {
            if (this.path) this.ref.updateState(this.value[this.path]);
            else this.ref.updateState(this.value);
        }
   ...
   */ createAction(name, action) {
        if (typeof name === "string" && typeof action === "function") this.actions[name] = action;
        else {
            if (typeof name === "object" && !action) for (const [nam, action1] of Object.entries(name)){
                if (typeof nam === "string" && typeof action1 === "function") this.actions[nam] = action1;
   ...
   */ bindRef(Ref, path) {
        ...
        } else throw new Error("✘  Cradova err :  Invalid ref component" + Ref);
    }
    /**
   *  Cradova Signal
   * ----
   ...
   */ clearPersist() {
        if (this.persistName) localStorage.setItem(this.persistName, JSON.stringify(""));
    }
}


const $14558a07fc6e8338$export$55185c17a0fcbe46 = {};
$14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRouteController"] = null;
 ...
 */ const $14558a07fc6e8338$var$checker = (url)=>{
    // first strict check
    if ($14558a07fc6e8338$export$55185c17a0fcbe46.routes[url]) return [
        $14558a07fc6e8338$export$55185c17a0fcbe46.routes[url],
        null
    ];
    // place holder check
    for(const path in $14558a07fc6e8338$export$55185c17a0fcbe46.routes){
        ...
        if (pathFixtures.length === urlFixtures.length) {
            ...
            for(let i = 0; i < pathFixtures.length; i++){
                ...
                if (!(pathFixtures.indexOf(urlFixtures[i]) === pathFixtures.lastIndexOf(urlFixtures[i]))) throw new Error(" ✘  Cradova err:  cradova router doesn't allow paths with multiple names");
            }
            if (isIt) {
                for(let i1 = 0; i1 < pathFixtures.length; i1++)if (pathFixtures[i1].includes(":")) routesParams[pathFixtures[i1].split(":")[1]] = urlFixtures[i1];
                return [
 ...
 */ $14558a07fc6e8338$export$55185c17a0fcbe46.route = function(path = "/", screen) {
 ...
 */ $14558a07fc6e8338$export$55185c17a0fcbe46.navigate = function(href, data = null, force = false) {
    if (typeof data === "boolean") {
        force = true;
        data = null;
    }
    if (typeof href !== "string") throw new TypeError(" ✘  Cradova err:  href must be a defined path but got " + href + " instead");
    ...
    if (href.includes(".")) window.location.href = href;
        ...
        if (route) {
            ...
            link = href;
            $14558a07fc6e8338$export$55185c17a0fcbe46["pageHide"] && $14558a07fc6e8338$export$55185c17a0fcbe46["pageHide"](href + " :navigated");
 ...
 */ $14558a07fc6e8338$export$55185c17a0fcbe46.router = async function(e, force = false) {
    ...
    if (url === $14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRoute"]) return;
    ...
    if (route) {
        ...
        $14558a07fc6e8338$export$55185c17a0fcbe46.params.params = params || null;
        $14558a07fc6e8338$export$55185c17a0fcbe46.params.data = $14558a07fc6e8338$export$55185c17a0fcbe46.params.data || null;
        $14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRouteController"] && $14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRouteController"].deactivate($14558a07fc6e8338$export$55185c17a0fcbe46.params);
        await route.controller($14558a07fc6e8338$export$55185c17a0fcbe46.params, force);
        $14558a07fc6e8338$export$55185c17a0fcbe46["pageShow"] && $14558a07fc6e8338$export$55185c17a0fcbe46["pageShow"](url);
        $14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRoute"] = url;
        $14558a07fc6e8338$export$55185c17a0fcbe46["lastNavigatedRouteController"] = route;
        // click handlers
    ...
    if ($14558a07fc6e8338$export$55185c17a0fcbe46.routes["/404"]) $14558a07fc6e8338$export$55185c17a0fcbe46.routes["/404"].controller($14558a07fc6e8338$export$55185c17a0fcbe46.params);
    else // or error
    console.error(" ✘  Cradova err: route '" + url + "' does not exist and no /404 route given!");
};
$14558a07fc6e8338$export$55185c17a0fcbe46["onPageShow"] = /**
   * @param {Event} callback Click event.
   */ function(callback) {
    if (typeof callback === "function") $14558a07fc6e8338$export$55185c17a0fcbe46["pageShow"] = callback;
    else throw new Error(" ✘  Cradova err:  callback for pageShow event is not a function");
};
$14558a07fc6e8338$export$55185c17a0fcbe46["onPageHide"] = function(callback) {
    if (typeof callback === "function") $14558a07fc6e8338$export$55185c17a0fcbe46["pageHide"] = callback;
    else throw new Error(" ✘  Cradova err:  callback for pageHide event is not a function");
};
/**
 ...
 */ $14558a07fc6e8338$export$55185c17a0fcbe46.packageScreen = async function(path, data) {
...
window.addEventListener("pageshow", $14558a07fc6e8338$export$55185c17a0fcbe46.router);
...
class $f6990bd003c706fc$export$a98515d67472a41f {
   ...
   */ persist = true;
    ...
    constructor(cradova_screen_initials){
        const { template: template , name: name , callBack: callBack , transition: transition , persist: persist  } = cradova_screen_initials;
        if (typeof template !== "function") throw new Error(" ✘  Cradova err:   only functions that returns a cradova element is valid as screen");
    ...
    async package(data) {
        if (this.template.firstChild) // @ts-ignore
        ...
        if (typeof this.html === "function") {
            ...
            if (typeof fuc === "function") {
                fuc = fuc(data);
                if (!(fuc instanceof HTMLElement)) throw new Error(" ✘  Cradova err:   only parent with descendants is valid");
                else this.template.append(fuc);
            }
        }
        //  @ts-ignore
        if (!this.template.firstChild) throw new Error(" ✘  Cradova err:  no screen is rendered, may have been past wrongly, try ()=> screen; in cradova Router.route(name, screen)");
    ...
    addChild(...addOns) {
        for(let i = 0; i < addOns.length; i++){
            if (addOns[i] && addOns[i] instanceof HTMLElement) this.secondaryChildren.push(addOns[i]);
            if (addOns[i] && typeof addOns[i] === "function") this.secondaryChildren.push(addOns[i]());
        }
    }
    detach() {
        // clearing the dom
        ...
        for(let i = 0; i < screens.length; i++){
            ...
            if (this.transition) screen.classList.remove("CRADOVA-UI-" + this.transition);
    ...
    async Activate(data, force) {
        ...
        //  @ts-ignore
        if (this.template.firstChild.afterMount) //  @ts-ignore
        this.template.firstChild.afterMount();
        if (this.transition) this.template?.classList.add("CRADOVA-UI-" + this.transition);
...
class $6d1c6e7469cb566a$export$e460bf4b68e36254 {
    history = [];
    Scaffolds = {};
    async push(label, data, force) {
        ...
        } else throw new Error("✘  Cradova err : no  Scaffold labeled  " + label + " provided!");
    }
    ...
    async addScaffolds(scaffolds) {
        ...
        for(const label in scaffolds){
            ...
            if (scaffold.template) this.Scaffolds[label] = scaffold;
            else {
                console.error("✘  Cradova got", scaffold);
                throw new Error("✘  Cradova err : Scaffold of label '" + label + "' didn't receive a invalid Scaffold component type");
            }
            if (i === 0) lab = label;
            i++;
        }
...
const $8c50abc064e8cb26$export$8048b892d651b310 = function(errors, err, type) {
    for(let er = 0; er < errors.length; er++)console.error(" ✘  Cradova err:  ", errors[er]);
    if (!type) throw new Error(" ✘  Cradova err:  " + err);
    else throw new TypeError(" ✘  Cradova err:  " + err);
};
...
`;
    const icon = (styles)=>(0, $882b6d93070905b3$export$2e2bcd8739ae039)("div", {
            ...styles,
            innerHTML: svg
        });
    const constr = (0, $882b6d93070905b3$export$2e2bcd8739ae039)("div", {
        display: "flex",
        position: "fixed",
        alignContent: "center",
...
function $8c50abc064e8cb26$export$987d49ffe1b0900f(value, ...properties) {
 ...
 @media styles using javascript*/ const styS = "@media only screen and (" + value + ") " + "{" + `
`, styE = "}" + `
`;
    let style = "  ", aniSty = " ";
    ...
    const animationStep = (num)=>{
        style = "  ";
        for (const [k, v] of Object.entries(properties[num][1]))style += "" + k + ": " + v + ";" + `
`;
...
function $8c50abc064e8cb26$export$dbf350e5966cf602(identifier, properties) {
 ...
 css styles using JavaScript*/ const styS = "" + identifier + "" + "{" + `
`;
    const styE = "}" + `
`;
    let style = "", totalStyle = "";
    for (const [k, v] of Object.entries(properties))style += "" + k + ": " + v + ";" + `
`;
...
function $8c50abc064e8cb26$export$e3607ec2d7a891c4(identifier, ...properties) {
    /*This is for creating css  
 animations  using JavaScript*/ const styS = "@keyframes " + identifier + " " + "{" + `
`, styE = "}" + `
...
function $8c50abc064e8cb26$export$6011af8918805fc(element_initials = "div", props = {}) {
    props.stateID = $8c50abc064e8cb26$export$31b40729666a4ae0();
    const element = (0, $882b6d93070905b3$export$2e2bcd8739ae039)(element_initials, props);
    return {
        render (data) {
            return element(data);
        },
...
class $8c50abc064e8cb26$export$1b6f95c075a87882 {
    ...
    render(datas) {
        ...
        if (!this.datas) throw new Error(" ✘  Cradova err:  RefList cannot be rendered without input");
        if (!Array.isArray(this.datas)) throw new Error(" ✘  Cradova err:  RefList cannot render non-array input");
        const elements = [];
    ...
    updateState(datas) {
        if (!datas) throw new Error(" ✘  Cradova err:  Ref cannot be rendered without input");
        if (!Array.isArray(datas)) throw new Error(" ✘  Cradova err:  RefList cannot render non-array input");
        if (!datas[0]) return;
        if (!this.parentElement) // only for the first call
        this.parentElement = (0, $c2ad58edccfaf3f7$export$635e15bbd66f01ea)(this.stateID, {
            cradovaDispatchtrackBreak: true
        })[0]?.parentElement;
        if (!this.parentElement) throw new Error("✘  Cradova err :  cannot update list parent element is no where to be found");
        const elements = [];
...
class $8c50abc064e8cb26$export$9bcc32033bdd12aa {
   ...
   */ render(...data) {
        ...
        if (!this.data) throw new Error(" ✘  Cradova err : Ref cannot be rendered without input");
        const chtml = this.component(...this.data);
        if (typeof chtml !== "function") throw new Error(" ✘  Cradova err :  Invalid component type for cradova Ref, got  -  " + chtml);
        const element = chtml({
            stateID: this.stateID
        });
        if (!(element instanceof HTMLElement)) $8c50abc064e8cb26$export$8048b892d651b310([
            `
   ...
   */ updateState(...data) {
        if (!data) return;
        if (!this) {
            console.error(" ✘  Cradova err:  update has been passed wrongly please send the ref where you want to call it");
            console.error(" ✘  Cradova err: Then call as ref.updateState({ your new data }) = ui state");
        }
        const guy = (0, $c2ad58edccfaf3f7$export$635e15bbd66f01ea)(this.stateID, {
            cradovaDispatchtrackBreak: true
        })[0];
        if (!guy) // console.log(this.component);
        throw new Error(" ✘  Cradova err:  Ref is not rendered but updateState was called");
        const chtml = this.component(...data);
        if (typeof chtml !== "function") try {
            guy.parentNode.replaceChild(chtml, guy);
        } catch (e) {
            console.error(" ✘  Cradova err:  ", e);
            throw new Error(" ✘  Cradova err:   Ref got an invalid datatype for ref updateSate call  got >>>  ' " + chtml + "';");
        }
        const element = chtml({
            stateID: this.stateID
        });
...
function $c2ad58edccfaf3f7$var$cradovaDispatchtrack(nodes, state) {
    for(let i = 0; i < nodes.length; i++){
        ...
        if (typeof state === "object") // updating the element's state
        for(const key in state){
            ...
            if (key === "fullscreen") {
                if (state[key]) (0, $8c50abc064e8cb26$export$708e76f13b8a286c)(element).set();
            ...
            if (key === "class" && typeof state[key] === "string") {
                ...
                for(let i1 = 0; i1 < classes.length; i1++)if (classes[i1]) element.classList.add(classes[i1]);
                continue;
            }
            ...
            if (key === "tree") {
                ...
                if (typeof state[key] === "function") state[key] = state[key]();
                if (Array.isArray(state[key])) throw new TypeError(" ✘  Cradova err:   invalid tree element type, should be a single element or parent element from cradova");
                if (!(state[key] instanceof HTMLElement)) {
                    console.error(" ✘  Cradova err:   wrong element type: can't update element state on " + state[key]);
...
function $c2ad58edccfaf3f7$export$635e15bbd66f01ea(stateID, state) {
    const nodes = [];
    const updated = [];
    if (typeof state === "undefined" && typeof stateID === "object") for (const [id, eachState] of Object.entries(stateID)){
        // filtering;
 ...
 */ function $2ba70f089ec95838$export$7a330199b2e76989(url, opts = {}) {
    // getting params
    const { method: method , data: data , header: header , callbacks: callbacks  } = opts;
    if (typeof url !== "string") throw new Error("✘  Cradova err : little Axios invalid url " + url);
    ...
    return new Promise(function(resolve) {
        ...
        if (callbacks && typeof callbacks === "object") {
            for (const [k, v] of Object.entries(callbacks))if (typeof v === "function" && ajax[k]) ajax[k] = v;
        }
        ajax.addEventListener("load", function() {
            resolve(ajax.response);
        });
        if (data && typeof data === "object") for (const [k1, v1] of Object.entries(data)){
            let value = v1;
            if (typeof value === "object" && value && !value.name) value = JSON.stringify(value);
            formData.set(k1, value);
        }
        ajax.addEventListener("error", (e)=>{
            console.error("✘  Cradova Ajax err : ", e);
            if (!navigator.onLine) resolve(JSON.stringify({
        ...
        if (!method) ajax.open(data && typeof data === "object" ? "POST" : "GET", url, true);
        else ajax.open(method, url, true);
        // setting header
        if (header && typeof header === "object") Object.keys(header).forEach(function(key) {
 ...
 */ const $882b6d93070905b3$var$_ = (...element_initials)=>{
    ...
    if (typeof element_initials[1] == "object" && !(element_initials[1] instanceof HTMLElement && !element_initials[1].tagName)) {
        properties = element_initials[1];
        if (properties?.beforeMount) beforeMount = properties["beforeMount"];
        if (element_initials.length > 2) childrens = element_initials.slice(2, element_initials.length);
    } else if (element_initials[1] instanceof HTMLElement || typeof element_initials[1] === "function" || typeof element_initials[1] === "string") childrens = element_initials.slice(1, element_initials.length);
    if (element_initials[0].raw) // getting the value of static cradova calls
    element_initials[0] = element_initials[0]["raw"][0];
    // verifying the children array
    function identify(element_initials) {
        if (typeof element_initials !== "object") element_initials = [
            element_initials
        ];
     ...
     */ return (...incoming)=>{
       ...
       */ let childrens2rd = [], props = {}, text;
            for(let i = 0; i < incoming.length; i++){
                ...
                if (// !incoming[i].tagName &&
                !(incoming[i] instanceof HTMLElement) && !Array.isArray(incoming[i]) && typeof incoming[i] === "object" && !incoming[i].tagName) {
            ...
            for(const prop in properties){
                if (prop === "style" && typeof properties[prop] === "object") {
                    for (const [k, v] of Object.entries(properties[prop]))element.style[k] = v;
                    continue;
                }
                ...
                try {
                    ...
                    throw new Error(" ✘  Cradova err:  invalid props  " + prop + " for this element type with value " + properties[prop]);
                }
            }
            //
            // dynamic props
            // over-rides props that appear in the first level
            if (props && typeof props === "object" && !Array.isArray(props)) for(const prop1 in props){
                if (prop1 === "style" && typeof props[prop1] === "object") {
                    for (const [k1, v1] of Object.entries(props[prop1]))element.style[k1] = v1;
                    continue;
                }
                ...
                try {
                    ...
                    console.error(" ✘  Cradova err:  ", error2);
                }
            }
            // getting children ready
            if (childrens2rd.length) for(let i2 = 0; i2 < childrens2rd.length; i2++){
                // single child lane
                if (typeof childrens2rd[i2] === "function") {
                    ...
                    try {
                        ...
                        console.error(" ✘  Cradova err:  ", error3);
                        if (!(child instanceof HTMLElement)) throw new Error("  ✘  Cradova err:  invalid child type: " + child + " (" + typeof child + ")");
                    }
                    continue;
                }
                // children array
                ...
                if (child1 instanceof HTMLElement || child1 instanceof DocumentFragment || typeof child1 === "string") {
                    ...
                    console.error(" ✘  Cradova err:   got", child1);
                    throw new Error("  ✘  Cradova err:  invalid child type: (" + typeof child1 + ")");
                }
            }
            //
            ...
            if (element.stateID) // adding cradova dynamic signature
    ...
    if (!CradovaElement) throw new Error(" ✘  Cradova err:  invalid element initials  " + element_initials);
