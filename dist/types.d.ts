export declare type CradovaElementType = HTMLElement & Record<string, any> & {
 ...
 */
export declare type CradovaHTMLElementType = (...element_initials: any[]) => ((...element_initials: any[]) => "NO TEMPLATE STRING PROVIDED") | ((...element_initials: any[]) => HTMLElement | undefined);
...
export declare type RouterRouteObject = {
...
export declare type fragmentTYPE = () => (() => HTMLElement) | HTMLElement;
/**
 *
 * Cradova Ajax
 * ------------------
 ...
 * @returns any
 */
export declare type Ajax = (url: string | URL, opts?: any) => Promise<any>;
